-- Update get_user_modules function to include new 'patients' and 'doctors' modules
...
AS $function$
  ...
  SELECT unnest(ARRAY['dashboard', 'dispensing', 'pos', 'debtors', 'stock', 'reports', 'management', 'patients', 'doctors', 'help']::app_module[])
